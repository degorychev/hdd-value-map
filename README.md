...
В репозитории есть два готовых безопасных примера:

- [demo/dns-sanitized.har](demo/dns-sanitized.har)
- [demo/regard-sanitized.har](demo/regard-sanitized.har)

Они собраны из реальных выгрузок и очищены от приватных данных:
...
Если хочешь быстро посмотреть инструмент в работе:

1. Сначала загрузи `dns-sanitized.har`
2. Потом добавь `regard-sanitized.har`
3. Нажми `Построить анализ`
...
- `demo/dns-sanitized.har` — безопасный пример для DNS
- `demo/regard-sanitized.har` — безопасный пример для Regard
